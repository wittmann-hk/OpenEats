    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rating', models.IntegerField(default=0, help_text=b'rating of the meal', verbose_name='rating')),
                ...
                ('course', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.recipe_groups.Course', verbose_name='course')),
                ('cuisine', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.recipe_groups.Cuisine', verbose_name='cuisine')),
                ('related', models.OneToOneField(blank=True, help_text=b'relate another recipe', null=True, on_delete=django.db.models.deletion.CASCADE, related_name='RecipeRelated', to='api.recipe.Recipe', verbose_name='related')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pub_date', models.DateTimeField(auto_now_add=True)),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.recipe.Recipe', unique=True, verbose_name='recipe')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('recipe', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.recipe.Recipe', verbose_name='recipe')),
